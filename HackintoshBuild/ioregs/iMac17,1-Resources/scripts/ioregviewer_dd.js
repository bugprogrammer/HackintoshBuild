...
function Initiate(direct){
    ...
    if (runOnce == 0) {
        ...
        left_tree_url="IORegistry/IORegViewer/iMac17,1-Resources/dataFiles/"+direct+"/"+direct+".html";
...
function loadInitialRightTreeFile(folderToRead,fileToLoad){
	// Called from the /IORegistry/IORegViewer/iMac17,1-Resources/dataFiles//*/*.html
    ...
    right_tree_url="IORegistry/IORegViewer/iMac17,1-Resources/dataFiles//"+folderToRead+"/"+fileToLoad+".txt";
...
function RefreshLeftTree(dropdown){
	...
	// build the url for the desired left tree file.
    left_tree_url="IORegistry/IORegViewer/iMac17,1-Resources/dataFiles//"+selectedValue+"/"+selectedValue+".html";
    
    // Refresh Left tree.
    $("div#leftPaneTree").jstree('refresh');
    
    // Load property data for Root node in right tree and refresh it. 
    right_tree_url="IORegistry/IORegViewer/iMac17,1-Resources/dataFiles//"+selectedValue+"/data1.txt";
...
function loadFile(folderToRead,fileToLoad){
	...
	// Each node date file: /IORegistry/IORegViewer/iMac17,1-Resources/dataFiles//*/*.html

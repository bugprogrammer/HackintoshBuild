/*
 * It file sets up the browser ready for reading and displaying HTML and JSON data files 
...
function Initiate(direct){
    ...
    left_tree_url="MacBookPro10,1-Resources/dataFiles/"+direct+"/"+direct+".html";
...
function loadInitialRightTreeFile(folderToRead,fileToLoad){
	// Called from the /MacBookPro10,1-Resources/dataFiles/*/*.html
    ...
    right_tree_url="MacBookPro10,1-Resources/dataFiles/"+folderToRead+"/"+fileToLoad+".txt";
...
function RefreshLeftTree(dropdown){
	...
	// build the url for the desired left tree file.
    left_tree_url="MacBookPro10,1-Resources/dataFiles/"+selectedValue+"/"+selectedValue+".html";
    
    // Refresh Left tree.
    $("div#leftPaneTree").jstree('refresh');
    
    // Load property data for Root node in right tree and refresh it. 
    right_tree_url="MacBookPro10,1-Resources/dataFiles/"+selectedValue+"/data1.txt";
...
function loadFile(folderToRead,fileToLoad){
	...
	// Each node date file: /MacBookPro10,1-Resources/dataFiles/*/*.html
    ...
    jQuery(document).ready(function(){
        ...
        $.get(right_tree_url, function(data){ 
                ...
                .jstree({
	                ...
	                grid: {columns: [{"width":240},{"width":80,"value":"ColType"},{"width":thirdColumnWidth,"value":"ColValue"},]},

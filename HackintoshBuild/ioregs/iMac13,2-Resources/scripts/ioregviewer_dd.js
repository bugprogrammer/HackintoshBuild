...
function Initiate(direct){
    ...
    left_tree_url="IORegDump/IORegViewer/iMac13,2-Resources/dataFiles//"+direct+"/"+direct+".html";
...
function loadInitialRightTreeFile(folderToRead,fileToLoad){
	// Called from the /IORegDump/IORegViewer/iMac13,2-Resources/dataFiles//*/*.html
    ...
    right_tree_url="IORegDump/IORegViewer/iMac13,2-Resources/dataFiles//"+folderToRead+"/"+fileToLoad+".txt";
...
function RefreshLeftTree(dropdown){
	...
	// build the url for the desired left tree file.
    left_tree_url="IORegDump/IORegViewer/iMac13,2-Resources/dataFiles//"+selectedValue+"/"+selectedValue+".html";
    
    // Refresh Left tree.
    $("div#leftPaneTree").jstree('refresh');
    
    // Load property data for Root node in right tree and refresh it. 
    right_tree_url="IORegDump/IORegViewer/iMac13,2-Resources/dataFiles//"+selectedValue+"/data1.txt";
...
function loadFile(folderToRead,fileToLoad){
	...
	// Each node date file: /IORegDump/IORegViewer/iMac13,2-Resources/dataFiles//*/*.html
        ...
        $.get(left_tree_url, function(data){ 
            ...
            $("div#leftPaneTree").jstree({
               core : { "animation" : 100 }, // , "initially_open": "root" - not used as using class="jstree-open" in html file.
		    	...
		    	types: { "types":{ "large" :{ "icon" : { "image" : "iMac13,2-Resources/assets/large.png" }}}}
             })

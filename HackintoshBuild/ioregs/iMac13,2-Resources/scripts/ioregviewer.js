...
function Initiate(direct){
    ...
    left_tree_url="iMac13,2-Resources/dataFiles/"+direct+"/"+direct+".html";
...
function loadInitialRightTreeFile(folderToRead,fileToLoad){
	// Called from the /iMac13,2-Resources/dataFiles/*/*.html
    ...
    right_tree_url="iMac13,2-Resources/dataFiles/"+folderToRead+"/"+fileToLoad+".txt";
...
function RefreshLeftTree(dropdown){
	...
	// build the url for the desired left tree file.
    left_tree_url="iMac13,2-Resources/dataFiles/"+selectedValue+"/"+selectedValue+".html";
    
    // Refresh Left tree.
    $("div#leftPaneTree").jstree('refresh');
    
    // Load property data for Root node in right tree and refresh it. 
    right_tree_url="iMac13,2-Resources/dataFiles/"+selectedValue+"/data1.txt";
...
function loadFile(folderToRead,fileToLoad){
	...
	// Each node date file: /iMac13,2-Resources/dataFiles/*/*.html
